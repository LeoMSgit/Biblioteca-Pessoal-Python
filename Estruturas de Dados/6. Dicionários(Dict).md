...
```
### 5.6) {}.items()
- Retorna uma lista de tuplas contendo todos os pares de chaves e valores do dicionário
- Existem 3 principais métodos de mostrar os valores encontrados com {}.items():
  1. View: cria um objeto iteral com os valores e chaves e mostra
  2. Lista: converter o dicionário para lista e mostrar os valores
  3. Loop: criar um loop para imprimir cada par em um formato personalizado
```python
pessoa = {"nome": "Leonardo", "idade": "27", "sexo": "Masc", "telefone": "11 99843-8731"}

# 1. View
print(pessoa.items()) # Saída: [('nome', 'Leonardo'), ('idade', 26)]
